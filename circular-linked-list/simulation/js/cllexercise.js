...
var boxDist = 148;
var index, color_stopper, shift_stopper, keyc, numa, num, value, numb;
var headX = 180;
var headY = 110;
var topgap = 170;
var leftgap = 120;
...
function q2() {
  for (var i = 0; i < numbers.length; i++) tvalues[i] = numbers[i];
  ...
  ques_string.innerHTML =
    ques_string.innerHTML + " " + tvalues[tvalues.length - 1];
}
function check() {
  ansl = 0;
  if (numbers.length != tvalues.length) ansl = 1;
  else {
